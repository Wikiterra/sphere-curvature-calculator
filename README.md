...
### 1. Pitagoras Theorem
- Teorema de Pitágoras: <img src="https://render.githubusercontent.com/render/math?math=a²+b²=c² \Rightarrow c=\sqrt{a²+b²}"> ![img](http://www.sciweavers.org/tex2img.php?eq= &bc=White&fc=Black&im=jpg&fs=12)
